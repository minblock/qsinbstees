    ...
    platformStyle(_platformStyle)
{
    ...
    QString windowTitle = tr("QSTEES-CORE") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(platformStyle->QsteesgleColorIcon(":/icons/overview1"), tr("&Overview"), this);
    ...
    sendCoinsAction = new QAction(platformStyle->QsteesgleColorIcon(":/icons/send1"), tr("&Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a QSTEES address"));
    ...
    //depositCoinsAction = new QAction(platformStyle->QsteesgleColorIcon(":/icons/deposit"), tr("&Timelock"), this);
    //depositCoinsAction->setStatusTip(tr("Timelock coins to a QSTEES address"));
    ...
    receiveCoinsAction = new QAction(platformStyle->QsteesgleColorIcon(":/icons/receiving_addresses1"), tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qsinbstees: URIs)"));
    ...
    historyAction = new QAction(platformStyle->QsteesgleColorIcon(":/icons/history1"), tr("&Transactions"), this);
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(platformStyle->QsteesgleColorIcon(":/icons/masternodes"), tr("&Infinity Nodes"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your QSTEES addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified QSTEES addresses"));
    ...
    openAction->setStatusTip(tr("Open a qsinbstees: URI or payment request"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to QSTEES network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
    ...
    connectionsControl->setPixmap(platformStyle->QsteesgleColorIcon(icon).pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
}
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    if(secs < 90*60)
    {
        ...
        labelBlocksIcon->setPixmap(platformStyle->QsteesgleColorIcon(":/icons/synced").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
    ...
    //
        ...
        if(count != prevBlocks)
        {
            labelBlocksIcon->setPixmap(platformStyle->QsteesgleColorIcon(QString(
...
{
    QString strTitle = tr("QSTEES"); // default title
...
{
    labelWalletHDStatusIcon->setPixmap(platformStyle->QsteesgleColorIcon(hdEnabled ? ":/icons/hd_enabled" : ":/icons/hd_disabled").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelWalletEncryptionIcon->setPixmap(platformStyle->QsteesgleColorIcon(":/icons/lock_open").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
    ...
    case WalletModel::Locked:
        labelWalletEncryptionIcon->show();
        labelWalletEncryptionIcon->setPixmap(platformStyle->QsteesgleColorIcon(":/icons/lock_closed").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
...
void BitcoinGUI::updateProxyIcon()
{
    ...
    if (proxy_enabled) {
        if (labelProxyIcon->pixmap() == 0) {
            ...
            labelProxyIcon->setPixmap(platformStyle->QsteesgleColorIcon(":/icons/proxy").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
    ...
    menu(0)
{
    ...
    setStyleSheet(QString("QLabel { color : #FF8204; }").arg(platformStyle->QsteesgleColor().name()));
}
