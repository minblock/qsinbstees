...
CAmount GetMasternodePayment(int nHeight, int qsinbsteestype)
{
    CAmount ret = 0.00;
...
void ThreadScriptCheck() {
    RenameThread("qsinbstees-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Basic testing to ensure pays go to correct qsinbsteesnode tiers
