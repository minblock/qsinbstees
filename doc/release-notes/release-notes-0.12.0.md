...
- #6583 `af9305a` add support for miniupnpc api version 14 (Pavel Vaqsinbstees)
...
- #6484 `1369d69` use CHashWriter also in SignVerifyMessageDialog (Pavel Vaqsinbstees)
