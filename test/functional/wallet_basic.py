...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert(self.nodes[1].getaddresqsinbsteesfo(address_to_import)["iswatchonly"])
        ...
        for mode in [True, False]:
            ...
            for label in [u'рыба', u'𝅘𝅥𝅯']:
                ...
                assert_equal(self.nodes[0].getaddresqsinbsteesfo(addr)['label'], label)
        ...
        # Test getaddresqsinbsteesfo. Note that these addresses are taken from disablewallet.py
        assert_raises_rpc_error(-5, "Invalid address", self.nodes[0].getaddresqsinbsteesfo, "3J98t1WpEZ73CNmQviecrnyiWrnqRhWNLy")
        address_info = self.nodes[0].getaddresqsinbsteesfo("mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ")
