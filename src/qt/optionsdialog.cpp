    ...
    mapper(0)
{
    ...
    ui->qsinbsteesAtStartup->setToolTip(ui->qsinbsteesAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->qsinbsteesAtStartup->setText(ui->qsinbsteesAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openQSTEESConfButton->setToolTip(ui->openQSTEESConfButton->toolTip().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->qsinbsteesAtStartup, OptionsModel::StartAtStartup);
