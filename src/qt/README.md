...
Used to process BIP21 and BIP70 (see https://github.com/qsinbstees/qsinbstees/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a qsinbstees:... link from a browser).
...
* `qsinbsteesstrings.cpp`: automatically generated
* `qsinbsteesunits.(h/cpp)`: QSTEES / mQSTEES / etc handling
* `callback.h`
...
* don't change `local/qsinbstees_en.ts`; this happens [automatically](/doc/translation_process.md#writing-code-with-translations)
...
4. Enter "qsinbstees-qt" as project name, enter src/qt as location
5. Leave the file selection as it is
6. Confirm the "summary page"
7. In the "Projects" tab select "Manage Kits..."
8. Select the default "Desktop" kit and select "Clang (x86 64bit in /usr/bin)" as compiler
9. Select LLDB as debugger (you might need to set the path to your installation)
10. Start debugging with Qt Creator (you might need to the executable to "qsinbstees-qt" under "Run", which is where you can also add command line arguments)
