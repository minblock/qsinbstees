...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/qsinbstees/qsinbstees/pull/10340, but that change has been
    // postponed until after https://github.com/qsinbstees/qsinbstees/pull/10244 to
...
//
{
    ...
    int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-qsinbstees-address
            CScript scriptChange;
 ...
 * https://qsinbsteestalk.org/?topic=54527, or
 * https://github.com/qsinbstees/qsinbstees/pull/1393.
 */
