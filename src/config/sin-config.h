/* src/config/qsinbstees-config.h.  Generated from qsinbstees-config.h.in by configure.  */
/* src/config/qsinbstees-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_URL "https://qsinbsteesovate.io"
