...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for i in range(3):
            ...
            self.pubkey.append(self.nodes[i].getaddresqsinbsteesfo(newaddress)["pubkey"])
        ...
        assert ((self.nodes[0].getaddresqsinbsteesfo(uncompressed_spendable_address[0])['iscompressed'] == False))
        assert ((self.nodes[0].getaddresqsinbsteesfo(compressed_spendable_address[0])['iscompressed'] == True))
        ...
        for i in compressed_spendable_address:
            v = self.nodes[0].getaddresqsinbsteesfo(i)
            if (v['isscript']):
        ...
        v = self.nodes[0].getaddresqsinbsteesfo(compressed_solvable_address[1])
