...
class ImportPrunedFundsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        address_info = self.nodes[0].getaddresqsinbsteesfo(address1)
        ...
        address_info = self.nodes[1].getaddresqsinbsteesfo(address1)
        assert_equal(address_info['iswatchonly'], False)
        assert_equal(address_info['ismine'], False)

        address_info = self.nodes[1].getaddresqsinbsteesfo(address2)
        assert_equal(address_info['iswatchonly'], False)
        assert_equal(address_info['ismine'], False)

        address_info = self.nodes[1].getaddresqsinbsteesfo(address3)
        assert_equal(address_info['iswatchonly'], False)
        assert_equal(address_info['ismine'], False)
