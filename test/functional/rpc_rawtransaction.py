...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for type in ["bech32", "p2sh-segwit", "legacy"]:
            ...
            addrinfo = self.nodes[0].getaddresqsinbsteesfo(addr)
        ...
        addr2Obj = self.nodes[2].getaddresqsinbsteesfo(addr2)
        addr3Obj = self.nodes[2].getaddresqsinbsteesfo(addr3)
        ...
        mSigObjValid = self.nodes[2].getaddresqsinbsteesfo(mSigObj)
