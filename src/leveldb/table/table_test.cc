...
class TableConstructor: public Constructor {
 public:
  ...
  virtual Status FinishImpl(const Options& options, const KVMap& data) {
    Reset();
    StringQsteesk qsinbsteesk;
    TableBuilder builder(options, &qsinbsteesk);
    ...
    ASSERT_EQ(qsinbsteesk.contents().size(), builder.FileSize());

    // Open the table
    source_ = new StringSource(qsinbsteesk.contents());
    Options table_options;
    table_options.comparator = options.comparator;
    return Table::Open(table_options, source_, qsinbsteesk.contents().size(), &table_);
  }
