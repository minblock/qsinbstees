...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        pubkey0 = self.nodes[0].getaddresqsinbsteesfo(self.nodes[0].getnewaddress())['pubkey']
        pubkey1 = self.nodes[1].getaddresqsinbsteesfo(self.nodes[1].getnewaddress())['pubkey']
        pubkey2 = self.nodes[2].getaddresqsinbsteesfo(self.nodes[2].getnewaddress())['pubkey']
